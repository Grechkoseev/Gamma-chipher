namespace Lab_3;
/// <summary>
/// Регистр сдвига с линейной обратной связью из предыдущей лабораторной
/// </summary>
internal class Lfsr
{
    ...
    public List<int> BinaryOutputSequence { get; }
    public List<int> ByteSequenceList { get; }
    ...
    /// <summary>
    /// Вычисление однобайтового предствления выходной последовательности
    /// </summary>
    public void CountByteSequenceRepresentation()
    {
